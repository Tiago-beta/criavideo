...
def compose_video(
    ...
    if enable_audio_spectrum:
        ...
        filter_complex += (
            ...
            f"win_size=2048:overlap=0.72:colors=white,"
            f"format=rgba,drawgrid=w=14:h=8:t=1:c=black@1.0,colorkey=0x000000:0.03:0.0[bars_mask];"
            f"gradients=s={spectrum_width}x{spectrum_height}:n=8:"
            f"c0=0x2a7fff:c1=0x2fcbff:c2=0x2dff9b:c3=0xb8ff3b:"
            f"c4=0xffd33a:c5=0xff8d2f:c6=0xff3f56:c7=0xd833ff:"
            f"x0=0:y0={max(spectrum_height - 1, 0)}:x1=0:y1=0:speed=0,format=rgba[spectrum_grad];"
            f"[spectrum_grad][bars_mask]overlay=0:0:format=auto[spectrum];"
