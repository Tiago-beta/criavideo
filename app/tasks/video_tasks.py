...
async def run_realistic_video_pipeline(project_id: int):
    """Pipeline for realistic video generation via Seedance 2.0.
    ...
    async with async_session() as db:
        try:
            ...
            user_prompt = (project.lyrics_text or project.style_prompt or "").strip()
            if not user_prompt:
            ...
            if not os.path.exists(output_path) or os.path.getsize(output_path) == 0:
                raise RuntimeError("Seedance nao gerou o video ou o arquivo esta vazio.")
