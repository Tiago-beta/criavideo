...
async def ai_suggest(
    ...
    def _build_thumbnail_prompt_template(
        ...
        return (
            ...
            "- manter todo o texto dentro de uma area segura, com margem interna minima de 10% em todos os lados\n"
            "- nunca cortar letras, palavras, rosto ou objeto principal nas bordas; se precisar, reduzir o texto ate caber inteiro com folga\n"
            "- priorizar texto centralizado ou alinhado a esquerda, mas sempre totalmente visivel e bem afastado da borda esquerda\n"
